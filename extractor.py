...
if __name__ == '__main__':
    ...
    ext = CompositeExtractor(extractors)

    for e in extractors:
        ex_train = e.extract(train_x)
        ex_test = e.extract(test_x)
